...
echo "<td style='text-align: center'><a style='color:white; text-decoration: none;' href='print_invoice?add&id=".$row['invoice_id']."&date=".$row['time']."'><button class='btn btn-info'>Invoice</button></a></td>"; 
